;(function ($, document, window) {
    $.pictureViewer = function (options) {
        var pictureViewer_html =    '<div id="pictureViewer">' +
                                    ...
                                    '<div class="handel maximization hide" title="\u6700\u5927\u5316"></div>' +
                                    ...
                                    '<div class="counter">' +
                                    '<p class="words"></p><span class="num"></span> of <span class="total"></span>' +
                                    '</div>' +
                                    '</div>' +
                                    '</div>';
        //init param
        var $images = options.images,
            $wordsArr = options.words,
        ...
        var $words = $pictureViewer.find('.counter .words');
